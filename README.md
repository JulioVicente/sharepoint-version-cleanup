...
```powershell
iwr -useb https://raw.githubusercontent.com/JulioVicente/sharepoint-version-cleanup/v1.3.4/bootstrap.ps1 | iex
```
...
O lançador em `main` instala componentes fixados na tag `v1.3.4` e verifica SHA256. Para testar um checkout local, regenere o manifesto com `& .\tools\Update-ReleaseManifest.ps1` e execute `& .\bootstrap.ps1`.
