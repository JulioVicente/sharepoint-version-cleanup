...
```powershell
.\sharepoint-version-cleanup-v1.4.5.ps1 -Uninstall -WhatIf
.\sharepoint-version-cleanup-v1.4.5.ps1 -Uninstall
.\sharepoint-version-cleanup-v1.4.5.ps1 -CleanInstall -InstallPath 'C:\SPCleanup'
```
